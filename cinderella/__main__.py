...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="MT OFFICIAL", url="http://t.me/MT_Officials"),InlineKeyboardButton(text="🔱Add Me🔱",url="t.me/{}?startgroup=true".format(bot.username))]]
